...
public class ConsoleOutLoggerFactoryAdapter : AbstractSimpleLoggerFactoryAdapter
{
    ...
    /// ConfigurationSectionHandler for more information on how to use the
    ...
    {
        ILog log = new ConsoleOutLogger(name, level, showLevel, showDateTime, showLogName, dateTimeFormat, useColor);
        return log;
    }
}